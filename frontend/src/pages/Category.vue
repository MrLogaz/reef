<template>
  <q-page padding>
    ...
    <!-- <div class="text-h5 text-center full-width q-mb-md q-mt-md text-indigo-10"> -->
    <div class="text-h5 text-center full-width q-mb-md q-mt-md text-indigo-10" v-if="category">
    ...
    <div class="row justify-center" v-if="products && products.length">
      <div class="col-sm-6 col-xs-12" v-for="product in products" :key="product.id">
        <q-btn flat no-caps dense class="product-giftery q-pa-none" :to="'/' + seedkey + '/product/' + product.id">
          <q-card>
